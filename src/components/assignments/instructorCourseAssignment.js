...
const Assignment = props => (
    <tr>
        ...
        <td><input type="button" value="Mark Upload" className="btn btn-primary" onClick={props.onClick} id={props.id} /></td>
        <td><input type="button" value="View Submission" className="btn btn-primary" onClick={props.onClick2} id={props.id} /></td>
        {/* <td>
...
export default class InstructorCourseAssignment extends Component {
    ...
    onClick(e) {
        ...
        this.props.history.push("/user/instructor/submission/"+e.target.id);
    ...
    onClick2(e) {
        ...
        this.props.history.push("/user/instructor/allsubmission/"+e.target.id);
                                            ...
                                            <tbody>
...

                                                {
                                                    this.state.assignments.map((currentAssignment, i) => (
                                                        <Assignment onClick={this.onClick} onClick2={this.onClick2} id={currentAssignment._id} key={i} name={currentAssignment.name} publishDate={currentAssignment.publishDate} dueDate={currentAssignment.DueDate} allocatedMarks={currentAssignment.allocatedMarks}/>
                                                    ))
                                                }

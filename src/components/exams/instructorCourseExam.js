...
const Exam = props => (
    <tr>
        ...
        <td>{props.date}</td>
        <td>{props.venue}</td>
        <td><input type="button" value="Upload Marks" className="btn btn-primary" onClick={props.onClick} id={props.id} /></td>
        {/* <td>
...
export default class InstructorCourseExam extends Component {
    ...
    onClick(e) {
        ...
        this.props.history.push("/user/instructor/exammarkupload/"+e.target.id);
